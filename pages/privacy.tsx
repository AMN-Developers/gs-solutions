      ...
      <Flex gap={2} justifyContent={"space-between"} fontSize={"sm"}>
        ...
        >
          <Text as="p">
            ...
            plataforma EAD. Para que entendam melhor quais informações coletamos
            e como as utilizamos, armazenamos ou excluímos, detalhamos a seguir
            nossa Política de Privacidade.
          </Text>
          <Text as="p">
            Os dados cadastrais dos clientes não são divulgados para terceiros,
            exceto quando necessários para o processo de entrega, para cobrança
            ou participação em promoções solicitadas pelos clientes. Seus dados
            pessoais são peça fundamental para que o pedido chegue em segurança
            na sua casa, de acordo com o prazo de entrega estipulado.
          </Text>
          <Text as="p">
            A fim de facilitar o entendimento da nossa Política de Privacidade,
            apresentamos um resumo:
          </Text>
          <Text as="p">
            Agente de tratamento dos dados: <strong>G&S Home Solutions</strong>
          </Text>
          <Text as="p">
          ...
          <Text as="p">
            ...
            Cliente fornece quando se cadastra em nosso site ou plataforma EAD.
          </Text>
          <Text as="p">Com que finalidade utilizamos seus dados pessoais?</Text>
          <Text as="p">
        ...
        <Accordion defaultIndex={[0]} allowMultiple>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              <Text as="p" mb={2}>
                ...
                informações do Cliente de diversas formas, quando faz um pedido
                ou adquire um dos serviços oferecidos pelo site ou plataforma
                EAD; quando interage com o Serviço de Atendimento ao Consumidor;
                quando participa de pesquisas ou promoções de marketing etc.
                Dentre as informações que podem ser solicitadas estão: nome
                completo, e-mail, CPF, CNPJ, data de nascimento, gênero,
                endereço, números de telefone.
              </Text>
              <Text as="p" mb={2}>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text as="p" mb={2}>
                ...
                entregar os produtos ou serviços adquiridos; enviar atualizações
                sobre o status do pedido e comunicações de serviços; coordenar
                com parceiros a entrega ou disponibilização de serviços; prestar
                serviços adequados às necessidades do Cliente; melhorar a
                experiência de compra dos clientes na G&S Home Solutions; fazer
                análises e pesquisas de mercado; manter o Cliente informado
                sobre os produtos e serviços que oferecemos; executar
                publicidade online direcionada; prevenir, detectar e investigar
                atividades que estejam em desacordo com o nosso Código de
                Conduta ou que sejam proibidas ou ilegais; melhorar nosso
                website, produtos e serviços.
              </Text>
              <Text as="p" mb={2}>
                A G&S Home Solutions utiliza bases legais, que podem variar de
                acordo com a finalidade da coleta, para tratar os dados pessoais
                dos clientes. O prazo de armazenamento pode mudar conforme a
                base legal aplicável a cada situação e a finalidade.
              </Text>
              <Text as="p" mb={2}>
                Os serviços de marketing são oferecidos por meio de comunicações
                gratuitas sobre ofertas, serviços e produtos dirigidas ao
                Cliente, relacionadas ao seu perfil no site e a compras que fez.
                Esse serviço abrange e-mails, SMS e WhatsApp.
              </Text>
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              <Text as="p" mb={2}>
                Ao navegar em nosso site, ou se comunicar conosco, você concorda
                com o tratamento de suas informações, inclusive a transferência
                ...
                segurança, conforme os padrões de proteção de dados e de acordo
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              seguranca@gshomesolutions.com.br. Para mudar suas preferências em
              relação às notificações (incluindo as comunicações de marketing),
              a qualquer momento, você pode acessar o formulário de contato no
              site/ página Política de Privacidade. Se não quiser receber nossas
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              A G&S Home Solutions vende produtos com classificação de riscos, e
              suas compras devem ser comprados por adultos.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
            ...
            <AccordionPanel pb={4}>
              <Text as="p" mb={2}>
                ...
                computador ou em outros dispositivos (como ‘smartphones’ ou
                ‘tablets’) enquanto você navega no site. Utilizamos cookies,
                pixels e outras tecnologias (coletivamente, “cookies”) para
                reconhecer seu navegador ou dispositivo, aprender mais sobre
                seus interesses, fornecer recursos e serviços essenciais e
                também para:
              </Text>
              <UnorderedList>
                <ListItem>
              ...
              <Text as="p" mb={2}>
                ...
                desativá-los. Nos links abaixo você encontra mais detalhes sobre
                como desativar os cookies dos navegadores mais populares:
              </Text>
              <UnorderedList>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              Se alguma mudança for feita em nossa Política de Privacidade, você
              receberá um e-mail.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              O encarregado da proteção de dados é o responsável escolhido pelo
              G&S Home Solutions para atuar como canal de comunicação entre o
              controlador, os titulares dos dados e a Autoridade Nacional de
              Proteção de Dados (ANPD), quando ela for formalizada. Qualquer
              dúvida poderá ser encaminhada para o e-mail
              seguranca@gshomesolutions.com.br.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
            ...
            <AccordionPanel pb={4}>
              ...
              13.709/2018, independentemente das Leis de outros estados ou
              países, sendo competente o foro de domicílio do Cliente para
